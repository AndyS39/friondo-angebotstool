...
def main():
    ...
    pruefe("Kontroll KG", "Netto 30.245,43 € (v11: Z15 wieder eigene Position)", netto == 3024543, euro(netto))
    ...
    su = ang.summen()
    pruefe("Rabatt", "Endbetrag 35.492,06 € (Brutto − 500 €)", su["endbetrag"] == 3549206, euro(su["endbetrag"]))
