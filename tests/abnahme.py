...
def main():
    ...
    pruefe("Kontroll KG", "Netto 29.840,43 € (v11: 50-l-Puffer im Paket)", netto == 2984043, euro(netto))
    ...
    pruefe("Kontroll KG", "A13 = 8 m → Pos. 103 × 3 = +267,00 €", netto8 == 2984043 + 26700
    ...
    su = ang.summen()
    pruefe("Rabatt", "Endbetrag 35.010,11 € (Brutto − 500 €, v11)", su["endbetrag"] == 3501011, euro(su["endbetrag"]))
    eing = kfw.eingaben_aus_antworten(json.loads(ang.kfw_json), su["endbetrag"])
    erg = kfw.berechnen(parameter, eing)
    pruefe("Rabatt", "Zuschuss 19.600 €, Eigenanteil 15.410,11 € (v11)",
           erg.zuschuss_cent == 1960000 and erg.eigenanteil_cent == 1541011, euro(erg.eigenanteil_cent))
